...
Mario.Enemy.prototype.AwardPoints = function(){
    if (this.Type === Mario.Enemy.RedKoopa) {
        ...
        Mario.MarioCharacter.GetPoints(P_GREEN_KOOPA_DEAD);
    } else if (this.Type === Mario.Enemy.Goomba) {
        Mario.MarioCharacter.GetPoints(P_GOOMBA_DEAD);
    } else if (this.Type === Mario.Enemy.Spiky) {
        Mario.MarioCharacter.GetPoints(P_SPIKY_DEAD);
    } else if (this.Type === Mario.Enemy.Flower) {
        Mario.MarioCharacter.GetPoints(P_FLOWER_DEAD);
    }
}