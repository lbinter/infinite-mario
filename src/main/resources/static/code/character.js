...
Mario.Character.prototype.runningStop = function (xa) {
    if (this.isRunning) {
        logger.runningStop();
        this.isRunning = false;
    }
...
Mario.Character.prototype.GetPoints = function (points) {
    this.Score += points;
};
